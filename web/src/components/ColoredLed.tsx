...
const ColoredLed = ({ color }:ColoredLedProps) => {
    ...
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 480">
        <defs>
            <linearGradient y2="0" x2="1" y1="0" x1="0" id="circle">
                <stop offset="0" stopColor="#bfbfbf" />
                <stop offset="1" stopColor="#404040" />
            </linearGradient>
            <linearGradient spreadMethod="pad" y2="1" x2="1" y1="0" x1="0" id="main">
        ...
        <g>
            <title>Layer 1</title>
            <circle transform="rotate(90 320 240)" fillOpacity="0.77" id="svg_3" r="196.125" cy="240" cx="320" strokeLinecap="round" strokeWidth="17.5" fill="url(#circle)" />
            <circle id="svg_7" r="160" cy="239.999045" cx="319.252837" fillOpacity="0.64" strokeLinecap="round" strokeWidth="17.5" fill="url(#circle)" />
            <circle id="svg_8" r="150" cy="240.001698" cx="320.000535" strokeLinecap="round" strokeWidth="17.5" fill="url(#main)" />
